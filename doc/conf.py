...
if 'sys path setting':
    ...
    from console_color import __version__
...
project = 'Console Color'  # project_name
...
if 'my setting':
    ...
    if 'Disqus':
        ...
        disqus_url_root = f'https://carsonslovoka.github.io/console-color/{language}'
